...
# Инициализация бота и диспетчера с Markdown-разметкой
...
# Обработка сообщений с проверкой обращения и Markdown-разметкой
@dp.message()
async def chat_with_gemini(message: types.Message):
    ...
    try:
        ...
        await message.answer(f"Ошибка запроса: `{e}`", parse_mode="Markdown")
