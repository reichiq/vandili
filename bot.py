...
•📝 Заметки: «добавь заметку купить хлеб», «покажи мои заметки» или используй команду /mynotes — ты сможешь просматривать, редактировать, удалять или добавлять новые заметки через кнопки.
•⏰ Напоминания: «напомни завтра в 10:00 полить цветы по Варшаве» или команда /myreminders — напоминания можно добавлять, редактировать и удалять через удобные кнопки. Если не указать город/часовой пояс — я попрошу уточнить.
