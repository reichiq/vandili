...
•⏰ Напоминания: «напомни завтра в 10:00 полить цветы по Варшаве» — если вы не укажете часовой пояс, я спрошу его; также вы можете установить его, отправив сообщение «Мой часовой пояс: Europe/Warsaw» или «Мой город: Варшава».
